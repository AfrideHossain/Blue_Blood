...
if (isset($_POST["submit"])) {
    ...
    $mbody = "<div style='font-size: 1.2em; padding: 5px;'>
            ...
            <p style='color: orange; font-weight: bold; font-size: 1.4em;'>Ornament Your Haven</p>
            </div>
            <p>
    ...
    include("dbcon.php");
    $sql = "SELECT username FROM user_info WHERE email = '$mail'";
