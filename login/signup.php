<?php
if (!$_COOKIE["mailverified"] == 1) {
    echo "<script>window.location.href = 'mailver.php';</script>";
}
?>
<!DOCTYPE html>
<html>
        ...
        <form class="login-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-content">
                <div class="text-boxs">
                    ...
                    <div class="input-sec">
                        <input type="text" name="user_name" id="user_name" placeholder="Username" value="<?php echo $_COOKIE["uname"]; ?>" required /> <i class="fa fa-user"></i>
                    </div>
                    <div class="input-sec">
                        <input type="email" name="mail" id="mail" placeholder="Email Address" value="<?php echo $_COOKIE["mail"]; ?>" required /> <i class="fa fa-envelope-o"></i>
                    </div>
                    <div class="input-sec">
